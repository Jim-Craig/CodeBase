...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='/home/godwinkhalko/ISRO/UNET/isro_unet_resnet34.pth', help='Path to save the trained model')
    parser.add_argument('--checkpoint_path', type=str, default='/home/godwinkhalko/ISRO/UNET/checkpoint.pth', help='Path to save the checkpoint')
